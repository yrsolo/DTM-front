...
export function PromoPage() {
  ...
  return (
    <div className="promoLanding">
      <header className="promoGlassNav">
        <div className="promoGlassNav__inner">
          <a className="promoGlassNav__brand" href="#promo-hero" aria-label="DTM home">
            <span className="promoGlassNav__brandMark">DTM</span>
          </a>
      ...
      <main className="promoLanding__main">
