...
- Приложение стартует из [App.tsx](n:\PROJECTS\DTM\DTM-front\apps\web\src\app\App.tsx).
- `App.tsx` рендерит [Layout.tsx](n:\PROJECTS\DTM\DTM-front\apps\web\src\components\Layout.tsx) и [TimelinePage.tsx](n:\PROJECTS\DTM\DTM-front\apps\web\src\pages\TimelinePage.tsx).
...
- [TaskBar.tsx](n:\PROJECTS\DTM\DTM-front\apps\web\src\gantt\TaskBar.tsx)
